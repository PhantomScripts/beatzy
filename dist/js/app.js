...
function applyTheme() {
    ...
    if (appData.platform_name) {
        ...
        if (logoText) logoText.textContent = appData.platform_name;
    }
    if (appData.hero_title) {
        const heroTitle = document.getElementById('heroTitle');
        if (heroTitle) heroTitle.textContent = appData.hero_title;
    }
    if (appData.hero_desc) {
        const heroDesc = document.getElementById('heroDesc');
        if (heroDesc) heroDesc.textContent = appData.hero_desc;
    }
    if (appData.section_title) {
        const sectionTitle = document.getElementById('sectionTitle');
        if (sectionTitle) sectionTitle.textContent = appData.section_title;
    }
    if (appData.footer_text) {
        const footerText = document.getElementById('footerText');
        if (footerText) footerText.textContent = appData.footer_text;
    }
}
